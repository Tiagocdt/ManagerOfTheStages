...
# Save data to a file
def save_data(file_path, temperature, stage, time_in_hpf, data):
    print(f"Saving data: {temperature}, {stage}, {time_in_hpf} ...")
...
def add_entree(file_path, temperature, stage, time_in_hpf):
    ...
    # Add the time in HPF
    stage_entry["times"].append(float(time_in_hpf))
    
    # Save the updated data
    save_data(file_path, temperature, stage, time_in_hpf, data)
